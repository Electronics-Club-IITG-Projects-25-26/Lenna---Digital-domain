...
module top1
    ...
    wire out_ready1,out_valid1, intr1,out_ready2,out_valid2, intr2,out_ready3,out_valid3, intr3;
    wire [11:0] gray; 
    wire vga_out_valid;
    
    assign gray=(77*i_bram_pix_data[11:8] + 150*i_bram_pix_data[7:4]+ 29*i_bram_pix_data[3:0]);
    imageprocesstop red(
        .sel(sel1),
        .sel2(sel2),
        .sel3(sel3),
        .in_pixel(selin?{4'b0,i_bram_pix_data[11:8]}:gray[11:4]),
        .clk(i_top_pclk  ),
        .rst(r2_rstn_pclk),
        .out_pixel(out_red),
        .in_ready(1'b1),
        .valid_in(i_bram_pix_wr & out_ready1),
        .out_ready(out_ready1),
        .out_valid(out_valid1),
        .interupt(intr1)
    );
    imageprocesstop green(
        .sel(sel1),
        .sel2(sel2),
        .sel3(sel3),
        .in_pixel({4'b0,i_bram_pix_data[7:4]}),
        .clk(i_top_pclk  ),
        .rst(r2_rstn_pclk),
        .out_pixel(out_green),
        .in_ready(1'b1),
        .valid_in(i_bram_pix_wr & out_ready2),
        .out_ready(out_ready2),
        .out_valid(out_valid2),
        .interupt(intr2)
    );    
    imageprocesstop blue(
        .sel(sel1),
        .sel2(sel2),
        .sel3(sel3),
        .in_pixel({4'b0,i_bram_pix_data[3:0]}),
        .clk(i_top_pclk  ),
        .rst(r2_rstn_pclk),
        .out_pixel(out_blue),
        .in_ready(1'b1),
        .valid_in(i_bram_pix_wr & out_ready3),
        .out_ready(out_ready3),
...
begin
    ...
    else if(out_valid1&out_valid2&out_valid3)
    ...
    #(  .WIDTH(12                       ), 
     ...
     (
        ...
        .i_wclk(i_top_pclk              ),
        .i_wr(out_valid1&out_valid2&out_valid3), 
        .i_wr_addr(wr_addr      ),
        .i_bram_data(selin?{out_red[3:0],out_green[3:0],out_blue[3:0]}:{3{out_red[7:4]}}        ), 
        .i_bram_en(1'b1                 ),
    ...
    (
        ...
        .i_pix_data(selin2?~o_bram_pix_data:o_bram_pix_data), 
